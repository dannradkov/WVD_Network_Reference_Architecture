...
> ***UPDATE: At the time of this writing Private Link was in preview for App Service and testing was completed successfully.  Since publication, a bug was found with Private Link and WVD so this funtionality is currently unavailable.  We are actively working to fix this bug and will update this document once resolved.  We apologize for the delay***
